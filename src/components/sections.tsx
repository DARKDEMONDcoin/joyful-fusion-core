...
export const faqs = [
  {
    q: "ده كورس فيديوهات ولا فيه متابعة حقيقية؟",
    a: "فيه فيديوهات كمرجع، لكن الأساس متابعة لايف: جلسات مباشرة أسبوعية على شغلك إنت — عرضك، سعرك، متجرك، رسائل عملائك — ومراجعة على تنفيذك لحد ما توصل لنتيجة. المتابعة الفردية 1‑على‑1 متاحة في باقة المتابعة الشخصية بأماكن محدودة.",
  },
  {
    q: "فيه تجربة مجانية؟",
    a: "أيوه. تفتح حساب بـ 0 جنيه، تشوف المنصة ومقدمة كل مسار وخطة أول 3 أيام، وتحضر جلسة لايف تعريفية قبل أي دفع.",
  },
  {
    q: "أقدر ألغي؟ وفيه استرداد؟",
    a: "مفيش اشتراك شهري تلغيه — الباقة دفعة واحدة. والاسترداد متاح حسب سياسة الاسترداد المنشورة على الموقع خلال المدة الموضّحة فيها؛ راجعها قبل الشرا.",
  },
  {
    q: "فيه شهادة؟ ومعترف بيها؟",
    a: "بتاخد شهادة إتمام من الشركة (ميغسي — شركة مسجّلة في مصر بسجل تجاري ورقم ضريبي) تفيدك في ملفك وعروضك، وهي شهادة جهة تدريب مش شهادة جامعية معتمدة من الدولة. اللي بيجيبلك عملاء فعليًا هو شغلك الحقيقي (بورتفوليو) اللي بنبنيه معاك في الجلسات.",
  },
  {
    q: "وبتوصلوني للحرية المالية إزاي بالظبط؟",
    a: "بنمشي معاك على مراحل واضحة: أول دولار، بعده دخل شهري متكرر، بعده تحويل الشغل لأصل رقمي بيكبر من غيرك — بمتابعة لايف على كل مرحلة. ده تعليم وإرشاد عملي، مش استشارة مالية ولا وعد بدخل مضمون؛ النتيجة بتعتمد على تنفيذك.",
  },
  {
...
const plans = [
  {
    ...
    price: "0",
    unit: "جنيه",
    note: "تفتح حساب، تشوف المنصة من جوه، وتحضر جلسة لايف تعريفية قبل أي دفع.",
    cta: "ابدأ مجانًا",
    to: "/auth",
    highlight: false,
    features: [
      ...
      ["جلسة لايف تعريفية جماعية", true],
      ["جلسات لايف أسبوعية + مراجعة شغلك", false],
  ...
  },
  {
    ...
    note: "كل المسارات والأدوات، وجلسات لايف أسبوعية على شغلك، ووصول مدى الحياة بدون اشتراك شهري.",
    ...
    features: [
      ...
      ["جلسات لايف أسبوعية + مراجعة شغلك", true],
  ...
  },
  {
    ...
    price: "بالطلب",
    unit: "أماكن محدودة",
    note: "الباقة الكاملة + جلسات لايف فردية (1‑على‑1) ومتابعة لحد أول عميل.",
    cta: "اطلب مكانك",
    to: "/contact",
    highlight: false,
    features: [
      ["كل اللي في الباقة الكاملة", true],
      ["جلسات لايف فردية 1‑على‑1", true],
